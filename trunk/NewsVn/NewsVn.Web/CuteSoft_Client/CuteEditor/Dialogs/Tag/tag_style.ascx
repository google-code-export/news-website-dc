...
var OxOfdaf=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOfdaf[1],true)[OxOfdaf[0]]=function (){if(event[OxOfdaf[2]]){alert(element[OxOfdaf[3]].cssText);} ;} ;
</script>
