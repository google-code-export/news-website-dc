<%@ Page Title="" Language="C#" MasterPageFile="~/Account/SiteAdmin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="NewsVn.Web.Account.SiteAdmin.Post.AddCategory" %>
...
<asp:Content ContentPlaceHolderID="mainContent" runat="server">
    <div class="portlet">
        ...
        <nsn:SiteAdmin_UpdateCategory runat="server" />
    </div>    
</asp:Content>