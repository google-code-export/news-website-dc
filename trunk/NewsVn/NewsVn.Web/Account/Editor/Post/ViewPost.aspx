<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Editor/Editor.Master" AutoEventWireup="true" CodeBehind="ViewPost.aspx.cs" Inherits="NewsVn.Web.Account.Editor.Post.ViewPost" %>
...
<asp:Content ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="ui-table-toolbar">
        ...
        <div class="left">
            <asp:HyperLink ID="btnAdd" Text="Thêm" CssClass="button-add" runat="server"
                NavigateUrl="~/Account/Editor/Post/AddPost.aspx" />
    ...
    <asp:Repeater ID="rptPostList" OnItemDataBound="rptPostList_ItemDataBound" runat="server">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>                    
                    <asp:Literal ID="ltrPostLink" runat="server" />
                </td>
