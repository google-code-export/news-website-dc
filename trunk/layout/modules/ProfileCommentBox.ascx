...
<div class="portlet">
    ...
    <ul id="pmessageform_box" class="ui-form ui-widget">
        ...
        <% if (ShowEmail) { %>
        <li>
            <asp:Label AssociatedControlID="ddlCategory" Text="Gởi lời nhắn đến:" Width="100" runat="server" />
        ...
        <li class="commands">            
            <asp:LoginView runat="server">
                <AnonymousTemplate>
                    <asp:HyperLink CssClass="button-login right" Text="Đăng nhập để gởi tin" runat="server"
