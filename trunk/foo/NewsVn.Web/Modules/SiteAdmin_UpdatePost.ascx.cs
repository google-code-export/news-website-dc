            ...
            try
            {
                using (var ctx = new NewsVnContext(ApplicationManager.ConnectionString))
                {
                    ...
                    var post = new Impl.Entity.Post
                    {
                        ...
                        TitleAscii = clsCommon.RemoveDangerousMarks(clsCommon.RemoveUnicodeMarks(txtTitle.Text.Trim())).Replace("-", " "),
        ...
        private void ModifyPost(int postID)
        {
            using (var ctx = new NewsVnContext(ApplicationManager.ConnectionString))
            {
                ...
                if (post != null)
                {
                    ...
                    post.TitleAscii = clsCommon.RemoveDangerousMarks(clsCommon.RemoveUnicodeMarks(txtTitle.Text.Trim())).Replace("-"," ");
