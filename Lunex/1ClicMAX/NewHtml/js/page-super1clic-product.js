$(function() {	
	...
	// Support CSS Styling
	pages.super1Clic.identify();
	
	pages.super1Clic.refineTabContent();

	pages.super1Clic.showNewCustomerDialog();
	pages.super1Clic.showAddMultiNumbersDialog();
	pages.super1Clic.showEdit1ClicPhoneDialog();
	pages.super1Clic.showAddUsPhoneDialog();
	pages.super1Clic.showEditUsPhoneDialog();
	pages.super1Clic.showEditCustInfoDialog();
	pages.super1Clic.showRatesDialog();

	pages.super1Clic.confirmDelete1ClicNo();

	pages.super1Clic.slidePrintDropDown();

	pages.super1Clic.newAccountForm.choosePhoneType();
	
	pages.super1Clic.rechargeAccountForm.addAmount();
	pages.super1Clic.rechargeAccountForm.voidAmount();
...
pages = $.extend(pages, {
	super1Clic: {
		identify: function() {
			$(document.body).addClass("super1clic");
		},
