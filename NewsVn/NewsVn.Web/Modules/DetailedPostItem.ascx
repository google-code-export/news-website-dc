...
<div class="portlet detailed-post">
    ...
    <div class="info-bar head">
        ...
        <div class="right">
            <a href='http://www.facebook.com/sharer.php?u=<%=SeoUrl %>&t=<%=strTitle %>'title="Chia sẽ trên Facebook" target="_blank">
                <asp:Image ID="Image1" ImageUrl="/images/icons/facebook.png" runat="server" />
            </a>
             <a href='http://twitter.com/home?status=<%=strTitle %> <%=SeoUrl %>' title="Chia sẽ trên Twitter" target="_blank">
