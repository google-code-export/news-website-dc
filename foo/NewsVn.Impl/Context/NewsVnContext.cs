...
namespace NewsVn.Impl.Context
{
    public class NewsVnContext : DbContext, IDisposable
    {
        ...
        public Repository<Entity.KeyValueRef> KeyValueRefRepo
        {
            get
            {
                if (_keyValueRefRepo == null)
                {
                    _keyValueRefRepo = new Repository<Entity.KeyValueRef>(_ctx);
                }
                return _keyValueRefRepo;
            }
        }
